...
public class ProductServlet extends HttpServlet {
    ...
    private List<Car> getCarData() {
        ...
        cars.add(new Car(3, "XV", 155300.0, "/assets/video/XV-image.jpg", "/assets/video/XV.mp4", "/assets/cars/xv/xv-side.png", "/assets/cars/xv/xv-front.png", "Urban Explorer", "Style and capability.", "156hp", "196Nm", "194km/h", "10.4s", "10.4s", "CVT", xvColors, Stream.concat(xvExt.stream(), xvInt.stream()).collect(Collectors.toList()), xvExt, xvInt, xvHighlights));
        ...
        cars.add(new Car(5, "BRZ", 268500.0, "/assets/video/BRZ-image.jpg", "/assets/video/BRZ.mp4", "/assets/cars/brz/brz-side.png", "/assets/cars/brz/brz-front.png", "Unleash Your Desire", "Pure sports car DNA.", "234hp", "250Nm", "216km/h", "6.4s", "6.8s", "6-speed manual", brzColors, Stream.concat(brzExt.stream(), brzInt.stream()).collect(Collectors.toList()), brzExt, brzInt, brzHighlights));
